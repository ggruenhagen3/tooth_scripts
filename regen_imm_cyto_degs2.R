...
regen = merge(tjh, list(jawh, imi), add.cell.ids = c("ct", "cj", 'imi'))
...
saveRDS(regen_yc, "regen_yc2.rds")
...
write.csv(regen_yc_deg, "regen_yc_deg2.csv")
print("Done")
...
saveRDS(regen_nc, "regen_nc2.rds")
...
write.csv(regen_nc_deg, "regen_nc_deg2.csv")
print("Done")
